...
$(document).ready(function(){$(".humb").click(function(){$(".hide-menu").addClass("active")}),$(".sale-carousel").owlCarousel({items:4,mouseGrag:!1,margin:10,navText:['<span><i class="fa fa-angle-left" aria-hidden="true"></i> prev</span>','<span>next <i class="fa fa-angle-right" aria-hidden="true"></i></span>'],nav:!0});var e=$("#tabs");$(".tabs-content > div",e).each(function(e){0!=e&&$(this).hide(0)}),e.on("click",".tabs a",function(a){a.preventDefault();var t=$(this).attr("href");$(".tabs a",e).removeClass(),$(this).addClass("active"),$(".tabs-content > div",e).hide(0),$(t).show()}),$("#zoom_1").elevateZoom({gallery:"gal1",cursor:"pointer",galleryActiveClass:"active",imageCrossfade:!0,loadingIcon:"http://www.elevateweb.co.uk/spinner.gif"}),$("#zoom_1").bind("click",function(e){var a=$(".product-img img").data("elevateZoom");return $.fancybox(a.getGalleryList()),!1})}),$(document).mouseup(function(e){var a=$(".top-line-mnu-small");0===a.has(e.target).length&&$(".hide-menu").hasClass("active")&&a.parent(".hide-menu").removeClass("active")});var grid=document.querySelector(".grid"),msnry=new Masonry(grid,{itemSelector:".grid-item",columnWidth:".grid-sizer",percentPosition:!0});imagesLoaded(grid).on("progress",function(){msnry.layout()});